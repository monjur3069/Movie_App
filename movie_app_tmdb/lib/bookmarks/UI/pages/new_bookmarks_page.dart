...
class NewBookMarksPage extends StatefulWidget {
  const NewBookMarksPage({Key? key}) : super(key: key);

  @override
  State<NewBookMarksPage> createState() => _NewBookMarksPageState();
}

Future<List<LocalDBModel>> fetchData() async {
  return await DBHelper.getAllMovieDetails1();
}

class _NewBookMarksPageState extends State<NewBookMarksPage> {
  late var split;
