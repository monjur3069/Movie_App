class BookmarksModel {
  ...
  BookmarksModel.withError(String errorMessage){
    error = errorMessage;

  }

  BookmarksModel.fromJson(dynamic json) {
    adult = json['adult'];
  ...
  num? voteAverage;
  num? voteCount;
BookmarksModel copyWith({  bool? adult,
  String? backdropPath,
  BelongsToCollection? belongsToCollection,
  num? budget,
  List<Genres>? genres,
  ...
  num? voteAverage,
  num? voteCount,
}) => BookmarksModel(  adult: adult ?? this.adult,
